export const errors = {
    ...
    INVALID_ROBLOX_COOKIE: 'Your session expired. Please login again.',
    NOT_PREMIUM: 'Premium features are currently unavailable.',
    ...
    INVALID_RANGE_TOTAL: 'Item ranges must cover the full 1-100000 range.',
    INVALID_ITEM_NAME: 'Invalid item name.',
    INVALID_ITEM_PRICE: 'Invalid item price.',
    INVALID_ITEM_ID: 'Invalid item ID.',
    INVALID_IMAGE: 'Invalid image path or URL.',
    SLUG_ALREADY_EXISTS: 'That case slug is already in use.',
    CASE_HAS_OPENINGS: 'This case has openings and cannot be hard deleted.',
    CANNOT_EDIT_REFERENCED_VERSION: 'This active version has openings. Create a new version instead.',
    NOTHING_TO_UPDATE: 'No changes were provided.',
    INVALID_UPLOAD_IMAGE: 'Invalid image file. Use png/jpg/webp/gif and max size 5MB.',
    ...
    MISSING_DUMMY_ITEM: "Marketplace functionality is currently unavailable.",
    ...
    MIN_ROBUX_DEPOSIT: 'The minimum deposit amount is 10 coins.',
    ...
    INSUFFICIENT_DEPOSITS: "You need to have deposited at least 500 coins in the last two weeks to be able to withdraw.",
    NOT_ENOUGH_WAGERED: 'You need to have wagered at least 2,500 coins to be able to join rains.',
    SECURITY_QUESTION: "You aren't eligible to login using credentials. You can only login with cookie.",
    MAX_UNFILLED: "You can only have a maximum of 25,000 coins at once unfilled in the withdraw queue.",
    AFFILIATE_DEPOSIT_REQUIREMENT: "You need to have deposited at least 10 coins to set an affiliate code.",
    TIP_DEPOSIT_REQUIREMENT: "You need to have deposited at least 200 coins to tip.",
    AUTHENTICATOR_NOT_ENABLED: "Two-factor authentication is required for this action.",
    LISTING_REMOVED: "This listing has been removed.",
    ALREADY_USED_CODE: "You've already used this code.",
    ROBLOX_ACCOUNT_AGE_AFFILIATE: "Your account needs to be at least 90 days old to use an affiliate code.",
    ACCOUNT_AGE_AFFILIATE: "Your Cosmic Luck account has to be less than 30 days old to use an affiliate code.",
    INSUFFICIENT_DEPOSIT_PROMO: "You need to deposit at least 50 coins to redeem promo codes.",
    MIN_WITHDRAW_ROBUX: "The minimum withdrawal amount is 50 coins.",
    ...
    MIN_RAIN_TIP: "The minimum amount you can tip to rain is 25 coins.",
    MIN_DEPOSIT_CC: "The amount is below the minimum deposit.",
    MAX_DEPOSIT_CC: "The amount exceeds the maximum deposit.",
    MIN_LISTING_PRICE: "Minimum listing price is 300 coins.",
    ...
    TRADE_QUALITY_FILTER: "Please update your privacy settings.",
    INVENTORY_PRIVACY: "Please set your inventory to public in your privacy settings.",
    TRADE_PRIVACY: "Please enable trading in your privacy settings.",
    MINES_MIN_BET: "The minimum bet is 10 coins.",
    MINES_MAX_BET: "The maximum bet is 100,000 coins.",
