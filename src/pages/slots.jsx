...
function Slots(props) {
  ...
  return (
    <>
      <Title>Cosmic Luck | Slots</Title>
      <Meta name='title' content='Slots'></Meta>
      <Meta name='description' content='Play And Spin The Best Slots On Cosmic Luck To Win Coins!'></Meta>

      <div class='slots-base-container'>
        <SlotsHeader/>

        <div class='our-picks'>
          <div style={{ flex: 1, background: 'linear-gradient(270deg, #FF9901 0%, rgba(31, 214, 95, 0.00) 98.59%)', 'min-height': '1px' }}/>
          ...
          <div style={{ flex: 1, background: 'linear-gradient(90deg, #FF9901 0%, rgba(31, 214, 95, 0.00) 98.59%)', 'min-height': '1px' }}/>
        </div>
        ...
        <div class='bar' style={{ background: '#3a4250', width: '100%', 'min-height': '1px', margin: '0 0 20px 0' }}/>
      ...
      <style jsx>{`
        ...
        .our-picks p {
          ...
          filter: drop-shadow(0 0 15px rgba(31, 214, 95, 0.3));
