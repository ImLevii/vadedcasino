    ...
    <>
      <div class='modal' onClick={() => close()}>
        <div class='freecoins-container' onClick={(e) => e.stopPropagation()}>
          ...
          <div class='socials'>
            <a class='twitter' href='https://twitter.com/cosmicluckcom' target='_blank'>
            ...
            <a class='discord' href='https://discord.gg/cosmicluck' target='_blank'>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="12" viewBox="0 0 16 12" fill="none">
            ...
            <a class='youtube' href='https://youtube.com/@cosmicluck' target='_blank'>
            ...
            <a class='twitch' href='https://twitch.tv/cosmicluck' target='_blank'>
