                    ...
                    {props?.status === 'pending' && (
                        <svg class='cancel' xmlns="http://www.w3.org/2000/svg" width="14" height="15" viewBox="0 0 14 15" fill="none" onClick={async () => {
                            ...
                            if (res.success) {
                                ...
                                createNotification('success', 'Successfully cancelled your transaction.')
                            }
                        }}>
